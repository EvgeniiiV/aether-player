document.addEventListener('DOMContentLoaded', () => {
    ...
    function setActiveTrackIndicator(trackPath, fromClick = false, startTime = null) {
        ...
        if (targetButton) {
            ...
            console.log('[INDICATOR] Button classes after add:', targetButton.className);
            console.log('[INDICATOR] Button has .playing?', targetButton.classList.contains('playing'));
            console.log('[INDICATOR] Button text:', targetButton.textContent.trim());
            console.log('[INDICATOR] Button data-start-time:', targetButton.dataset.startTime);
            console.log('[INDICATOR] Button data-track-id:', targetButton.dataset.trackId);
        } else {
    ...
    function updateUI(data) {
        ...
        if (data.state === 'stopped') {
            ...
            // Устанавливаем индикацию активного трека только для playing
            // При паузе оставляем индикацию как есть
